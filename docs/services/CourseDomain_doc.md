...
<!--
  ...
  Source File: TrainingTracker.Api/Domain/Entities/Course.cs
  Component Type: service
  Template: lean_baseline_service_template.md
  Generated: 2026-02-13 18:25:27
...
- TrainingTracker.Api/Infrastructure/Persistence/TrainingTrackerDbContext.cs
-->


# Service: CourseDomain

**Namespace/Project**: [Project.Services]  
**File Location**: `src/Services/CourseDomain.cs`   
...
- Cross-repository format: `CourseDomain(../../database-repo/docs/tables/TableName_doc.md)`
- Same repository format: `CourseDomain(../database/tables/TableName_doc.md)`

**Related Services:** Link to dependent/consumer service docs:
- `CourseDomain(./ServiceName_doc.md)`
...
git log docs/services/CourseDomain_doc.md

# View changes with diffs
git log -p docs/services/CourseDomain_doc.md

# Search for specific business rule or feature
git log --grep="BR-[SVC]" docs/services/CourseDomain_doc.md
git log --grep="FN#####" docs/services/CourseDomain_doc.md
```

**Include feature tags in commit messages** to link documentation changes to work items:
```bash
git commit -m "docs: update CourseDomain - add prerequisite validation (FN12345_US067)"
```
...
```bash
git add docs/services/CourseDomain_doc.md
git commit -m "docs: add CourseDomain baseline documentation (FN#####_US#####)
