---
feature: CourseServiceFixed
domain: Backend
layer: API
component: CourseServiceFixed
status: deployed
version: 1.0
...
<!--
  ...
  Source File: TrainingTracker.Api/Domain/Services/ICourseService.cs
  Component Type: service
  Template: lean_baseline_service_template.md
  Generated: 2026-02-16 17:52:36
...
# Service: CourseServiceFixed

**Namespace/Project**: [Project.Services]  
**File Location**: `src/Services/CourseServiceFixed.cs`   
...
└──────────────────────┘
           ↓
┌──────────────────────┐
│   ► THIS SERVICE ◄   │  CourseServiceFixed
...
- Cross-repository format: `CourseServiceFixed(../../database-repo/docs/tables/TableName_doc.md)`
- Same repository format: `CourseServiceFixed(../database/tables/TableName_doc.md)`

**Related Services:** Link to dependent/consumer service docs:
- `CourseServiceFixed(./ServiceName_doc.md)`
...
git log docs/services/CourseServiceFixed_doc.md

# View changes with diffs
git log -p docs/services/CourseServiceFixed_doc.md

# Search for specific business rule or feature
git log --grep="BR-[SVC]" docs/services/CourseServiceFixed_doc.md
git log --grep="FN#####" docs/services/CourseServiceFixed_doc.md
```

**Include feature tags in commit messages** to link documentation changes to work items:
```bash
git commit -m "docs: update CourseServiceFixed - add prerequisite validation (FN12345_US067)"
```
...
```bash
git add docs/services/CourseServiceFixed_doc.md
git commit -m "docs: add CourseServiceFixed baseline documentation (FN#####_US#####)
