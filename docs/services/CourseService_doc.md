...
priority: P1
lastUpdated: 2026-02-17T13:09:02.867629
---
<!--
...
**Retrieve entity information**
- **Who**: User
- **What**: User retrieves data using Get
- **Preconditions**: User is authenticated, User has appropriate permissions
- **Steps**:
  1. User provides search criteria or ID
  2. System queries the database
...
**Retrieve entity information**
- **Who**: User
- **What**: User retrieves data using ListAsync
- **Preconditions**: User is authenticated, User has appropriate permissions
- **Steps**:
  1. User provides search criteria or ID
  2. System queries the database
...
**Create a new entity**
- **Who**: User
- **What**: User creates a new record using CreateAsync
- **Preconditions**: User is authenticated, User has appropriate permissions
- **Steps**:
  1. User provides required information
  2. System validates the input
...
**Delete an entity**
- **Who**: User
- **What**: User deletes a record using DeleteAsync
- **Preconditions**: User is authenticated, User has appropriate permissions
- **Steps**:
  1. User provides entity ID
  2. System verifies entity exists
...
- **Title is required**
  - Type: validation
- Example: Must provide Title- Violation: Validation error- **Title is required**
  - Type: validation
- Example: Must provide Title- Violation: Validation error- **Title must be between 1 and 200 characters**
  - Type: validation
- Violation: Validation error- **Title must be between 1 and 200 characters**
  - Type: validation
- Violation: Validation error- **Business invariant: A course with the title **
  - Type: invariant
- Violation: Operation fails with error- **Business invariant: A course with the title **
  - Type: invariant
...
> **Sync Status:** Last verified on 2026-02-17T13:09:02.867629
...
| `Unknown` | `GetAsync()` | Fetch data for operations | 🤖 [AI: Query pattern & optimization hints] |
| `Unknown` | `ExistsByTitleAsync()` | Fetch data for operations | 🤖 [AI: Query pattern & optimization hints] |
| `Unknown` | `GetAsync()` | Fetch data for operations | 🤖 [AI: Query pattern & optimization hints] |
| `Unknown` | `ExistsByTitleAsync()` | Fetch data for operations | 🤖 [AI: Query pattern & optimization hints] |
