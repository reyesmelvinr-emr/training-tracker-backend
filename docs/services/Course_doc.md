...
<!--
  ...
  Source File: Course.cs
  Component Type: service
  Template: lean_baseline_service_template.md
  Generated: 2026-02-13 17:57:59
...
**File Location**: `src/Services/Course.cs`   
...
- Cross-repository format: `Course(../../database-repo/docs/tables/TableName_doc.md)`
- Same repository format: `Course(../database/tables/TableName_doc.md)`

**Related Services:** Link to dependent/consumer service docs:
- `Course(./ServiceName_doc.md)`
...
git log docs/services/Course_doc.md

# View changes with diffs
git log -p docs/services/Course_doc.md

# Search for specific business rule or feature
git log --grep="BR-[SVC]" docs/services/Course_doc.md
git log --grep="FN#####" docs/services/Course_doc.md
```

**Include feature tags in commit messages** to link documentation changes to work items:
```bash
git commit -m "docs: update Course - add prerequisite validation (FN12345_US067)"
```
...
```bash
git add docs/services/Course_doc.md
git commit -m "docs: add Course baseline documentation (FN#####_US#####)
