---
feature: TestWildcard
domain: Backend
layer: API
component: TestWildcard
status: deployed
version: 1.0
...
<!--
  ...
  Source File: TrainingTracker.Api/Contracts/Courses/*Validator*.cs
  Component Type: service
  Template: lean_baseline_service_template.md
  Generated: 2026-02-16 17:52:24
...
- TrainingTracker.Api/Contracts/Courses/*Validator*.cs
- TrainingTracker.Api/Domain/Services/ICourseService.cs
-->


# Service: TestWildcard

**Namespace/Project**: [Project.Services]  
**File Location**: `src/Services/TestWildcard.cs`   
...
- Cross-repository format: `TestWildcard(../../database-repo/docs/tables/TableName_doc.md)`
- Same repository format: `TestWildcard(../database/tables/TableName_doc.md)`

**Related Services:** Link to dependent/consumer service docs:
- `TestWildcard(./ServiceName_doc.md)`
...
git log docs/services/TestWildcard_doc.md

# View changes with diffs
git log -p docs/services/TestWildcard_doc.md

# Search for specific business rule or feature
git log --grep="BR-[SVC]" docs/services/TestWildcard_doc.md
git log --grep="FN#####" docs/services/TestWildcard_doc.md
```

**Include feature tags in commit messages** to link documentation changes to work items:
```bash
git commit -m "docs: update TestWildcard - add prerequisite validation (FN12345_US067)"
```
...
```bash
git add docs/services/TestWildcard_doc.md
git commit -m "docs: add TestWildcard baseline documentation (FN#####_US#####)
